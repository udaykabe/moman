package net.deuce.moman.entity.service.envelope.impl;
...
@Component("envelopeService")
public class EnvelopeServiceImpl extends EntityServiceImpl<Envelope>
implements EnvelopeService {
