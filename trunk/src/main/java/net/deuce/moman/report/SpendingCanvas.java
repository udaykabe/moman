...
public class SpendingCanvas extends AbstractEnvelopeReportPieCanvas {
	...
	public SpendingCanvas(SpendingComposite parent, DateRangeCombo combo, int style) {
	...
	protected Chart doCreateChart() {
        ...
        NumberDataSet orthoValuesDataSet1 = NumberDataSetImpl.create(buildEnvelopeValues(result));
	    ...
	    TextDataSet categoryValues = TextDataSetImpl.create(buildCategories(result));
