...
public class EnvelopeSelectionCellEditor extends ControlLimitingCellEditor {
	...
	public EnvelopeSelectionCellEditor(ShiftKeyAware shiftKeyAwareControl,
			Composite parent) {
		super(parent);
	...
	private void handleSplitSelectionDialog(final Object value) {
		...
		final SplitSelectionDialog dialog = new SplitSelectionDialog(shell,
				getSplitAmount(value), split);
