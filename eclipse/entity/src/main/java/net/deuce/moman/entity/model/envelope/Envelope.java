...
public class Envelope extends AbstractEntity<Envelope> {
	...
	private transient AccountService accountService = ServiceProvider.instance().getAccountService();
	
	private transient EnvelopeService envelopeService = ServiceProvider.instance().getEnvelopeService();
	...
	public List<Envelope> getChildren() {
		return new LinkedList<Envelope>(children.values());
