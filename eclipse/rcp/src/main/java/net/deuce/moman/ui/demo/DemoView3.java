...
public class DemoView3 extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		String[] images = { ISharedImages.IMG_OBJ_FOLDER,
				ISharedImages.IMG_OBJ_PROJECT,
				ISharedImages.IMG_OBJ_PROJECT_CLOSED,
				ISharedImages.IMG_OBJS_BKMRK_TSK,
				ISharedImages.IMG_OBJS_ERROR_TSK,
				ISharedImages.IMG_OBJS_INFO_TSK,
				ISharedImages.IMG_OBJS_TASK_TSK,
				ISharedImages.IMG_OBJS_WARN_TSK, ISharedImages.IMG_OPEN_MARKER,
				ISharedImages.IMG_TOOL_BACK,
				ISharedImages.IMG_TOOL_BACK_DISABLED,
				ISharedImages.IMG_TOOL_BACK_HOVER, ISharedImages.IMG_TOOL_COPY,
				ISharedImages.IMG_TOOL_COPY_DISABLED,
				ISharedImages.IMG_TOOL_COPY_HOVER, ISharedImages.IMG_TOOL_CUT, };
